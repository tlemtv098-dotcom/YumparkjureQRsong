...
urlpatterns = [
    ...
    path("admin/users/<int:pk>/edit/", views_auth.user_edit_view, name="user_edit"),
    path("admin/users/<int:pk>/toggle/", views_auth.user_toggle_active_view, name="user_toggle_active"),
    path("admin/users/<int:pk>/delete/", views_auth.user_delete_view, name="user_delete"),

    # Admin - Genre Management
    path("admin/genres/", views_auth.genre_list_view, name="genre_list"),
    path("admin/genres/create/", views_auth.genre_create_view, name="genre_create"),
    path("admin/genres/<int:pk>/edit/", views_auth.genre_edit_view, name="genre_edit"),
    path("admin/genres/<int:pk>/delete/", views_auth.genre_delete_view, name="genre_delete"),

    # Admin - Tag Management
    path("admin/tags/", views_auth.tag_list_view, name="tag_list"),
    path("admin/tags/create/", views_auth.tag_create_view, name="tag_create"),
    path("admin/tags/<int:pk>/edit/", views_auth.tag_edit_view, name="tag_edit"),
    path("admin/tags/<int:pk>/delete/", views_auth.tag_delete_view, name="tag_delete"),
